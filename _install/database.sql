...
--
-- Host: localhost
-- Generation Time: Dec 26, 2019 at 02:48 PM
...
--
-- Table structure for table `tblcustomfields_category`
--

CREATE TABLE `tblcustomfields_categories` (
  `id` int(11) NOT NULL,
  `name` varchar(150) NOT NULL,
  `nav_type` tinyint(1) NOT NULL DEFAULT '0' -- 0 for side menu show / for  1 Profile Show 
...
--
ALTER TABLE `tblcustomfields_categories`
  ADD PRIMARY KEY (`id`);
--
-- Indexes for table `tblcustomfields`
--
