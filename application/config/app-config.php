...
*
*/
// define('APP_BASE_URL', 'https://crm.earlylearningleaders.org/perfex/');
...
*/
define('APP_ENC_KEY', '4737075ba6b1b4d091e27c92c27b7f06');
 ...
 */
define('APP_DB_USERNAME', 'xssuvbnhuu');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'jtseUR6YZF');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'xssuvbnhuu');
