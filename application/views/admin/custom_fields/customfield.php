                    ...
                    <div class="panel-body">
                        ...
                        <div class="customers_field_info mbot25 alert alert-info<?php if(isset($custom_field) && $custom_field->fieldto != 'customers' || !isset($custom_field)){echo ' hide';} ?>">
                            ...
                            <div class="select-placeholder form-group">
                                <label for="category_id"><?php echo _l('custom_field_add_edit_category_id'); ?></label>
                            <select name="category_id" id="category_id" class="selectpicker" data-width="100%" <?php echo $disable; ?> data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                <option value=""></option>
                                <?php foreach ($customfields_categories as $cfc) { ?>
                                    <option value="<?php echo $cfc['id']; ?>" <?php if(isset($custom_field) && $custom_field->category_id == $cfc['id']){echo 'selected';} ?>><?php echo $cfc['name']; ?></option>
                                <?php } ?>
                            </select>
                          </div>
                          <div class="select-placeholder form-group">
